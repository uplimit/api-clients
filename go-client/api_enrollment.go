...
*/
func (a *EnrollmentAPIService) V1EnrollUserIntoCoursePost(ctx context.Context) ApiV1EnrollUserIntoCoursePostRequest {
	return ApiV1EnrollUserIntoCoursePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EnrollmentAPIService) V1EnrollUserIntoCoursePostExecute(r ApiV1EnrollUserIntoCoursePostRequest) (*V1EnrollUserIntoSessionPost200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnrollmentAPIService.V1EnrollUserIntoCoursePost")
	if err != nil {
...
*/
func (a *EnrollmentAPIService) V1UnenrollUserFromSessionPost(ctx context.Context) ApiV1UnenrollUserFromSessionPostRequest {
	return ApiV1UnenrollUserFromSessionPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return V1EnrollUserIntoSessionPost200Response
func (a *EnrollmentAPIService) V1UnenrollUserFromSessionPostExecute(r ApiV1UnenrollUserFromSessionPostRequest) (*V1EnrollUserIntoSessionPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnrollmentAPIService.V1UnenrollUserFromSessionPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
