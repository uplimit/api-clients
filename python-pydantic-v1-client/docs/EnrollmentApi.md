...
------------- | ------------- | -------------
[**v1_enroll_user_into_course_post**](EnrollmentApi.md#v1_enroll_user_into_course_post) | **POST** /v1/EnrollUserIntoCourse | 
...
[**v1_unenroll_user_from_session_post**](EnrollmentApi.md#v1_unenroll_user_from_session_post) | **POST** /v1/UnenrollUserFromSession | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EnrollmentApi->v1_enroll_user_into_course_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnrollmentApi->v1_enroll_user_into_course_post: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EnrollmentApi->v1_unenroll_user_from_session_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnrollmentApi->v1_unenroll_user_from_session_post: %s\n" % e)
```
