...
class V1CreateUserPostRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateUserPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateUserPostRequest:
        """Create an instance of V1CreateUserPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateUserPostRequest.parse_obj(obj)

        _obj = V1CreateUserPostRequest.parse_obj({
