...
class ListSessionsInCourseResponseSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSessionsInCourseResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSessionsInCourseResponseSchema:
        """Create an instance of ListSessionsInCourseResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSessionsInCourseResponseSchema.parse_obj(obj)

        _obj = ListSessionsInCourseResponseSchema.parse_obj({
