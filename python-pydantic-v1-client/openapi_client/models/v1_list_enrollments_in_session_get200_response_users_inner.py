...
class V1ListEnrollmentsInSessionGet200ResponseUsersInner(BaseModel):
    """
    ...
    uplimit_active_subscription_commitment_ids: conlist(StrictStr) = Field(default=..., alias="uplimitActiveSubscriptionCommitmentIds", description="All the active subscription commitment ids for this user within this organization.")
    ...
    uplimit_session_enrollment_id: StrictStr = Field(default=..., alias="uplimitSessionEnrollmentId", description="The uplimit internal ID for the user enrollment in session.")
    __properties = ["emailAddress", "firstName", "lastName", "userAccountIsActive", "userHasValidSubscriptionEnrollment", "uplimitSubscriptionEnrollmentId", "uplimitSubscriptionCommitmentId", "uplimitActiveSubscriptionCommitmentIds", "uplimitUserId", "sessionCompletionStatus", "uplimitSessionEnrollmentId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListEnrollmentsInSessionGet200ResponseUsersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListEnrollmentsInSessionGet200ResponseUsersInner:
        """Create an instance of V1ListEnrollmentsInSessionGet200ResponseUsersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListEnrollmentsInSessionGet200ResponseUsersInner.parse_obj(obj)

        _obj = V1ListEnrollmentsInSessionGet200ResponseUsersInner.parse_obj({
            ...
            "uplimit_active_subscription_commitment_ids": obj.get("uplimitActiveSubscriptionCommitmentIds"),
            "uplimit_user_id": obj.get("uplimitUserId"),
            "session_completion_status": obj.get("sessionCompletionStatus"),
            "uplimit_session_enrollment_id": obj.get("uplimitSessionEnrollmentId")
        })
        return _obj
