...
class ToggleUserActivationSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ToggleUserActivationSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ToggleUserActivationSchema:
        """Create an instance of ToggleUserActivationSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ToggleUserActivationSchema.parse_obj(obj)

        _obj = ToggleUserActivationSchema.parse_obj({
