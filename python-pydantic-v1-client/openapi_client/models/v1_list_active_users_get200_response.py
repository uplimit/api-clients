...
class V1ListActiveUsersGet200Response(BaseModel):
    """
    V1ListActiveUsersGet200Response
    """
    users: conlist(V1GetUserInformationEmailAddressOrUserIdGet200Response) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListActiveUsersGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListActiveUsersGet200Response:
        """Create an instance of V1ListActiveUsersGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListActiveUsersGet200Response.parse_obj(obj)

        _obj = V1ListActiveUsersGet200Response.parse_obj({
            "users": [V1GetUserInformationEmailAddressOrUserIdGet200Response.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None,
