...
class V1ListCoursesGet200ResponseCoursesInner(BaseModel):
    ...
    uplimit_course_description: StrictStr = Field(default=..., alias="uplimitCourseDescription", description="The description of the course (may be empty).")
    name: StrictStr = Field(default=..., description="The name of the course.")
    __properties = ["uplimitCourseId", "uplimitCourseSlug", "uplimitCourseDescription", "name"]
    ...
    def from_dict(cls, obj: dict) -> V1ListCoursesGet200ResponseCoursesInner:
        ...
        _obj = V1ListCoursesGet200ResponseCoursesInner.parse_obj({
            ...
            "uplimit_course_description": obj.get("uplimitCourseDescription"),
            "name": obj.get("name")
        })
        return _obj
