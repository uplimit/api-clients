...
class UplimitUserInformationSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UplimitUserInformationSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UplimitUserInformationSchema:
        """Create an instance of UplimitUserInformationSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UplimitUserInformationSchema.parse_obj(obj)

        _obj = UplimitUserInformationSchema.parse_obj({
