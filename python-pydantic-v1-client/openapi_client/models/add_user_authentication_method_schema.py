...
class AddUserAuthenticationMethodSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddUserAuthenticationMethodSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddUserAuthenticationMethodSchema:
        """Create an instance of AddUserAuthenticationMethodSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddUserAuthenticationMethodSchema.parse_obj(obj)

        _obj = AddUserAuthenticationMethodSchema.parse_obj({
