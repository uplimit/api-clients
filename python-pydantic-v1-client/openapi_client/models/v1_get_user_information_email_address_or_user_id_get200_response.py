...
class V1GetUserInformationEmailAddressOrUserIdGet200Response(BaseModel):
    """
    ...
    __properties = ["emailAddress", "firstName", "lastName", "userAccountIsActive", "userHasValidSubscriptionEnrollment", "uplimitSubscriptionEnrollmentId", "uplimitSubscriptionCommitmentId", "uplimitActiveSubscriptionCommitmentIds", "uplimitUserId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1GetUserInformationEmailAddressOrUserIdGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1GetUserInformationEmailAddressOrUserIdGet200Response:
        """Create an instance of V1GetUserInformationEmailAddressOrUserIdGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1GetUserInformationEmailAddressOrUserIdGet200Response.parse_obj(obj)

        _obj = V1GetUserInformationEmailAddressOrUserIdGet200Response.parse_obj({
