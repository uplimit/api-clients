...
class V1GetUserInformationEmailAddressOrUserIdGet200Response(BaseModel):
    ...
    __properties = ["emailAddress", "firstName", "lastName", "userAccountIsActive", "userHasValidSubscriptionEnrollment", "uplimitSubscriptionEnrollmentId", "uplimitSubscriptionCommitmentId", "uplimitUserId"]
