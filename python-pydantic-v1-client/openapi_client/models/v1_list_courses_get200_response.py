...
class V1ListCoursesGet200Response(BaseModel):
    """
    V1ListCoursesGet200Response
    """
    courses: conlist(V1ListCoursesGet200ResponseCoursesInner) = Field(...)
    total_count: Union[StrictFloat, StrictInt] = Field(default=..., alias="totalCount")
    __properties = ["courses", "totalCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListCoursesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListCoursesGet200Response:
        """Create an instance of V1ListCoursesGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListCoursesGet200Response.parse_obj(obj)

        _obj = V1ListCoursesGet200Response.parse_obj({
            "courses": [V1ListCoursesGet200ResponseCoursesInner.from_dict(_item) for _item in obj.get("courses")] if obj.get("courses") is not None else None,
