...
class ListActiveUsersResponseSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListActiveUsersResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListActiveUsersResponseSchema:
        """Create an instance of ListActiveUsersResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListActiveUsersResponseSchema.parse_obj(obj)

        _obj = ListActiveUsersResponseSchema.parse_obj({
