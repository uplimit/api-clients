...
class ListInactiveUsersResponseSchema(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInactiveUsersResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInactiveUsersResponseSchema:
        """Create an instance of ListInactiveUsersResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInactiveUsersResponseSchema.parse_obj(obj)

        _obj = ListInactiveUsersResponseSchema.parse_obj({
